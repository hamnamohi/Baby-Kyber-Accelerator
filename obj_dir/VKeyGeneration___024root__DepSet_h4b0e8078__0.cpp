...
VL_INLINE_OPT void VKeyGeneration___024root____Vdpiimwrap_KeyGeneration__DOT__rng0__DOT__generate_random_number_TOP(IData/*31:0*/ min_value, IData/*31:0*/ max_value, IData/*31:0*/ &generate_random_number__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VKeyGeneration___024root____Vdpiimwrap_KeyGeneration__DOT__rng0__DOT__generate_random_number_TOP\n"); );
    // Body
    int min_value__Vcvt;

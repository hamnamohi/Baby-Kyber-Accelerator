...
int main(int argc, char** argv) {
    ...
    dut->ciphertext[0][0][1] = 16;
    dut->ciphertext[0][0][2] = 16;
    dut->ciphertext[0][0][3] = 1;

    dut->ciphertext[0][1][0] = 14;
    dut->ciphertext[0][1][1] = 9;
    dut->ciphertext[0][1][2] = 16;
    dut->ciphertext[0][1][3] = 14;

    dut->ciphertext[1][0][0] = 15;
    dut->ciphertext[1][0][1] = 8;
    dut->ciphertext[1][0][2] = 16;
    dut->ciphertext[1][0][3] = 13;

...
int main(int argc, char** argv) {
    ...
    dut->secret_key[1][2] = 0;
    dut->secret_key[1][3] = -1;

    dut->ciphertext[0][0][0] = 3;
    dut->ciphertext[0][0][1] = 10;
    dut->ciphertext[0][0][2] = 11;
    dut->ciphertext[0][0][3] = 11;

    dut->ciphertext[0][1][0] = 11;
    dut->ciphertext[0][1][1] = 13;
    dut->ciphertext[0][1][2] = 4;
    dut->ciphertext[0][1][3] = 4;

    dut->ciphertext[1][0][0] = 15;
    dut->ciphertext[1][0][1] = 8;
    dut->ciphertext[1][0][2] = 6;
    dut->ciphertext[1][0][3] = 7;
